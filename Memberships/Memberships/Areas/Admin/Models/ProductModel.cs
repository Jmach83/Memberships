...
namespace Memberships.Areas.Admin.Models
{
    public class ProductModel
    {
        ...
        public int ProductTypeIs { get; set; }
        ...
        public string ProductType
        {
            get
            {
                return ProductTypes == null || ProductTypes.Count.Equals(0) ? string.Empty : ProductTypes.First(pt => pt.Id.Equals(ProductTypeIs)).Title;
            }
        }
